const invoiceConfig = {
  ...
  clients: [
    ...
    },
    {
      ...
      billingAddress: "",
      monthlyRetainer: Number(process.env.INVOICE_DEFAULT_MONTHLY_RETAINER || 0),
      driveFolderName: "LBM x MUIZ NAZMI (HONDA)",
    },
    {
      ...
      billingAddress: "",
      monthlyRetainer: Number(process.env.INVOICE_DEFAULT_MONTHLY_RETAINER || 0),
      driveFolderName: "LBM x KAK SUE KITCHEN",
    },
    {
      ...
      billingAddress: "",
      monthlyRetainer: Number(process.env.INVOICE_DEFAULT_MONTHLY_RETAINER || 0),
      driveFolderName: "LBM x AZ HUSTLER EMPIRE",
    },
  ],
};
